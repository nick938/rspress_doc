...
3. Web server failed to start. Port 57880 was already in use. Spring Boot应用端口号被占用
...
4. 如果新建的maven/gradle项目下载不来依赖，那就给idea添加代理
代理地址是127.0.0.1:7890 ，这样在本地开了vpn后就可以正常从maven仓库下载依赖

5. GitHub提交或者拉去代码老是timeout或者连接失败。
